...
import com.dzikirqu.android.util.LocaleProvider.Companion.init
import com.dzikirqu.android.util.praytimes.Praytime
import com.dzikirqu.android.util.textfont.TypeFactory
...
//        Thread.setDefaultUncaughtExceptionHandler(object: CrashHandler(applicationContext){})
        AppCompatDelegate.setDefaultNightMode(com.dzikirqu.android.data.Prefs.appTheme)
    }
