        ...
        withContext(Dispatchers.IO) {
            ...
            getApplication<Application>().contentResolver.query(
                ...
                while (cursor.moveToNext()) {
                    ...
                    println("The display name of the image ${displayName}")
                    ...
                    val image = MediaStoreImage(id, displayName, dateModified, contentUri.toString(), width, height,size)
                    images += image

                    // For debugging, we'll output the image objects we create to logcat.
                    Log.v(TAG, "Added images: $image hello $size")
                }
            }
        }
