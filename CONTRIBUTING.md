...
> Adding more bakso restaurants to directory
...
A good way to figure out if you are not adhering to this rule is to tell yourself what you changed ("I added a picture of a cow to the Bottom navigation bar"). If you find yourself having multiple statements in this description then you have made your commit too big.

#### Examples

> Add an image of bakso, fix typos, rewrite `README.md`
...
> Add the nuclear reactor source code into the document where we add our thoughts
...
Here are some steps on how to make and commit a change, and create a pull request for review, using GitHub's web interface.

1. Navigate to the file to edit

2. Make your changes

3. Commit your changes and add a message
